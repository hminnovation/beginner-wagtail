...
APP_NAME = env.get('APP_NAME', 'beginner_wagtail')
...
if 'LOG_DIR' in env:
    # beginner_wagtail log
    LOGGING['handlers']['beginner_wagtail_file'] = {
        'level':        'INFO',
        'class':        'cloghandler.ConcurrentRotatingFileHandler',
        'filename':     os.path.join(env['LOG_DIR'], 'beginner_wagtail.log'),
        'maxBytes':     5242880,  # 5MB
        'backupCount':  5
    }
    LOGGING['loggers']['wagtail']['handlers'].append('beginner_wagtail_file')
